...
class Database:
    ...
    def spent(self):
        ...
        while isValid:
            amount = sd.askfloat("Spent", "How much did you spent?\n(range from $0.10 to $1000.00)", minvalue=0.1, maxvalue=1000)
        ...
        while isValid:
            item = sd.askstring("Spent", "What did you spent on?")
    ...
    def edit(self, index):
        if self.entries[index][0] == "earn":
            isValid = True
            while isValid:
                new_amount = sd.askfloat("Edit earn", "Please enter a new amount for this earn entry.", minvalue=0.1, maxvalue=1000)
                if new_amount == "":
                    mb.showerror("Empty field", "The input field is empty")
            ...
            isValid = True
            while isValid:
                new_amount = sd.askfloat("Edit spent", "Please enter a new amount for this spent entry.", minvalue=0.1, maxvalue=1000)
                if new_amount == "":
                    mb.showerror("Empty field", "The input field is empty")
                elif new_amount == None:
                    return
